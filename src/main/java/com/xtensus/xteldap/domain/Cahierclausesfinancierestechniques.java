...
/**
 * Cahierclausesfinancierestechniques generated by hbm2java
 */
@Entity
@Table(name = "cahierclausesfinancierestechniques")
public class Cahierclausesfinancierestechniques extends Entite implements java.io.Serializable {
