...
/**
 * Criterescahierclausesfinancierestechniquestype generated by hbm2java
 */
@Entity
@Table(name = "criterescahierclausesfinancierestechniquestype")
public class Criterescahierclausesfinancierestechniquestype extends Entite implements
